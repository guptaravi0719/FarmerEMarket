                ...
                children: <Widget>[
                  Expanded(
                    child: Column(
                      children: <Widget>[
                        Container(
                          child: Text("\Rs. ${widget.productDetailsNewPrice}",
...
//  }
  ...
  Widget buildDescription() {
    return ListTile(
      ...
      subtitle: Text(
          "This is a fresh crop producesd in december . It is at cheap price than outer markets. It is fresh and ready to use."),
    );
  }
}
