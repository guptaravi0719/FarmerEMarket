  ...
  Widget buildImgCarousel() {
    return Container(
      child: new Carousel(
        boxFit: BoxFit.cover,
        images: [
          AssetImage('img/Crop.jpeg'),
          AssetImage('img/animals.jpeg'),
          AssetImage('img/flower.jpg'),
          AssetImage('img/fruits.jpeg'),
          AssetImage('img/books.jpeg'),
          AssetImage('img/organic_vegetables.jpg'),
        ],
        autoplay: true,
